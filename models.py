...
class ProductVariant(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("reserved_quantity <= stock_quantity", name="ck_variants_reserved_not_over_stock"),
...
CHECKOUT_TRANSITIONS = {
    ...
    "payment_uncertain": {"completed", "payment_declined", "payment_cancelled", "expired"},
    "completed": {"refunded"},
    "refunded": set(),
    "expired": set(),
}
